...
## 3. Ethics Review
The surveys had data collected by different undergraduate students from year-to-year which potentially disrupts the standardization of the collection methods across the data-set. Additionally, these students were trained a week prior to collecting the data, and no-one was double-checking their identifications; this implies a baseline level of human error across all years.
