...
The variables that we will be using to explore our data are tide height, year, species, sea water temperature, proportion of quadrat cover, count and ascophyllum length. We do not anticipate needing to find any more data to help with this research question.
