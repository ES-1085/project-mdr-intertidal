...
```{r dominant-snails-species-animation, fig.alt = "Animation of the predominant snail species in each quadrat, divided by tide height. The animation is depicting a change in time from 2019 to 2023. 'Results'.")
...
max_snail_per_quadrat <- max_snail_species %>%
  ...
  labs(title = "The Predominant Snail Species of Each Quadrat in the Mount Desert Rock Intertidal",
...
#make multiple species into another column within the legend? -> so the colors of species match up between the graphs
