...
add_max_snail_species_1 <- add_max_snail_count %>%
  filter(max_count == 0) %>%
  mutate(snail_species_max = invert_species == NA)

add_max_snail_species_2 <- add_max_snail_count %>%
  filter(max_count != 0) %>%
  mutate(invert_snail_max = invert_species)


max_species_per_quadrat <- rbind(add_max_snail_species_1, add_max_snail_species_2) %>%
