...
```{r abundant-snails-animation, fig.height=3, fig.width=10}
...
max_snail_per_quadrat <- max_snail_species %>%
  ...
  labs(title = "Most Abundant Snail Species per Quadrat in the Mount Desert Rock Intertidal",
