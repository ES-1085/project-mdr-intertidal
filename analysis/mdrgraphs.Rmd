...
# laurie ? -> (1) how to fix lag in animation between title & graph change; (2) transition_length & state_ don't seem to be working...too long; (3) how to squash y-axis to make quadrats 'square' (scale in theme?); how to make set up to animation a single pipeline/how to condense code
