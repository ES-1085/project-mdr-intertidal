...
We also found that while some snail species (Littorina littorea, Littorina saxatilis) maintained relatively consistent representation for number of quadrats in which they are most abundant, others (Littorina obtusata, Nucella lapillus) fluctated drastically between holding the majority number of quadrats to very minimal number or vice versa (Lacuna vincta). Quadrats in which no snail species were found predominantly occurred at high tide height.

Further, we found that the mean seaweed cover for the subset of 6 species we examined was decreasing. This does not necessarily mean that total seaweed cover on MDR is decreasing; other species may be increasing. Similar to the variation in snail abundance, this variation may be due to the high-energy conditions of MDR. There may also be a relationship between increased herbivorous snails and decreased seaweed cover, but a manipulative experiment would be necessary to confirm a causal relationship.
